...
class ChatPage extends StatefulWidget {
  ...
  const ChatPage({super.key, required this.chatbotCode});
...
class _ChatPageState extends State<ChatPage> {
  ...
  void _sendMessage() async {
    ...
    // Hiển thị tin nhắn của người dùng và bật trạng thái đang tải
    setState(() {
    ...
    BodyChatbotAnswer chatbotRequest = BodyChatbotAnswer(
      ...
      collectionName:
          chatbotCode, // If collectionName is the same as chatbotCode
      customizePrompt:
      ...
      history: [], // An empty list for history
      historyId: "1086",
      intentQueue: [], // An empty list for intentQueue
      isNewSession: false,
      language: "Vietnamese",
      platform: "", // You may populate this if needed
      query: userQuery,
      rerankModel: "gpt-4o-mini",
      rewriteModel: "gpt-4o-mini",
      slots: [], // An empty list for slots
      slotsConfig: [], // An empty list for slotsConfig
      systemPrompt:
      ...
      type: "normal",
      userId: userId,
      userIndustry: "", // You can set this if necessary
    );
